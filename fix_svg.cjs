...
svg = svg.replace(
  /<svg\s+viewBox="0 0 612 408"/g,
  '<svg viewBox="0 0 612 408" className={className} style={style}',
);
...
fs.writeFileSync(
  "/Users/shivamsharma/Downloads/maisone-ai-sourcing-edge-main/src/components/maisone/SewingMachineIcon.tsx",
  componentCode,
);
