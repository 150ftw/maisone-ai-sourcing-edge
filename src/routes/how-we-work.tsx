  ...
  head: () => ({
    meta: [
      { title: "Production Lifecycle & Sourcing Loop — Maisone Global" },
      {
        name: "description",
        content:
          "A deep dive into Maisone's digital sourcing lifecycle: matching, sampling, auditing, and delivery.",
      },
    ],
  }),
          ...
          <div className="space-y-12">
            ...
            <div className="glass-strong rounded-3xl p-8 border border-white/5 space-y-4 hover:border-electric/20 transition-all">
              <div className="flex items-center gap-4">
                ...
                <h2 className="font-serif text-2xl text-foreground">
                  {t("howWeWorkPage.step2Title")}
                </h2>
              </div>
              <div className="pl-0 md:pl-16 space-y-3 text-muted-foreground text-sm leading-relaxed">
                <p>{t("howWeWorkPage.step2P1")}</p>
                <p>{t("howWeWorkPage.step2P2")}</p>
              </div>
            </div>
            ...
            <div className="glass-strong rounded-3xl p-8 border border-white/5 space-y-4 hover:border-electric/20 transition-all">
              <div className="flex items-center gap-4">
                ...
                <h2 className="font-serif text-2xl text-foreground">
                  {t("howWeWorkPage.step3Title")}
                </h2>
              </div>
              <div className="pl-0 md:pl-16 space-y-3 text-muted-foreground text-sm leading-relaxed">
                <p>{t("howWeWorkPage.step3P1")}</p>
                <p>{t("howWeWorkPage.step3P2")}</p>
              </div>
            </div>
            ...
            <div className="glass-strong rounded-3xl p-8 border border-white/5 space-y-4 hover:border-electric/20 transition-all">
              <div className="flex items-center gap-4">
                ...
                <h2 className="font-serif text-2xl text-foreground">
                  {t("howWeWorkPage.step4Title")}
                </h2>
              </div>
              <div className="pl-0 md:pl-16 space-y-3 text-muted-foreground text-sm leading-relaxed">
                <p>{t("howWeWorkPage.step4P1")}</p>
                <p>{t("howWeWorkPage.step4P2")}</p>
              </div>
            </div>
            ...
            <div className="glass-strong rounded-3xl p-8 border border-white/5 space-y-4 hover:border-electric/20 transition-all">
              <div className="flex items-center gap-4">
                ...
                <h2 className="font-serif text-2xl text-foreground">
                  {t("howWeWorkPage.step5Title")}
                </h2>
              </div>
              <div className="pl-0 md:pl-16 space-y-3 text-muted-foreground text-sm leading-relaxed">
                <p>{t("howWeWorkPage.step5P1")}</p>
                <p>{t("howWeWorkPage.step5P2")}</p>
              </div>
            </div>
          </div>
        </main>
