export const it = {
  ...
  hero: {
    ...
    weCurrentlySource: "Siamo",
    countries: "presenti in",
    ...
    lowMoqEcosystem: "Ecosistema a Basso MOQ",
    ...
    productionScaling: "ridimensionamento della produzione",
    requestLowMoqQuote: "Richiedi un preventivo a basso MOQ",
    minimumOrder: "Ordine Minimo",
    sampleDev: "Svil. Campione",
    capacityLabel: "Capacità",
    unlimitedCaps: "ILLIMITATO",
    piecesCaps: "Pezzi",
    daysCaps: "Giorni",
    scalingCaps: "Ridimensionamento",
  },
  ...
  howWeWork: {
    ...
    phase3Points: [
      ...
      "Esecuzione e supervisione della produzione",
