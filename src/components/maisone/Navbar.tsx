      ...
      <div className={`mx-auto max-w-7xl px-6 ${scrolled ? "" : ""}`}>
        ...
        >
          ...
          <nav className="hidden lg:flex items-center gap-8">
            <a
              href="/#home"
              className="text-sm font-medium text-[#2C2C2C]/80 dark:text-muted-foreground hover:text-black dark:hover:text-foreground transition-colors"
            >
              {t("nav.home")}
            </a>
            <a
        ...
        {open && (
          ...
          >
            <a
              ...
              className="text-sm font-medium text-[#2C2C2C]/80 dark:text-muted-foreground hover:text-black dark:hover:text-foreground py-2"
            >
              {t("nav.home")}
            </a>
            <a
