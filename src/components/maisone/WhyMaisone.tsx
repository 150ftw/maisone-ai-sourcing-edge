      ...
      <div className="mx-auto max-w-7xl px-6 relative z-10">
        ...
        >
          ...
          <h2 className="font-serif text-4xl sm:text-6xl tracking-tight text-balance">
            {t("why.heading")}{" "}
            <span className="italic gradient-text">{t("why.headingHighlight")}</span>
            {t("why.headingEnd")}
          </h2>
        </motion.div>
        ...
        <div className="flex flex-col lg:flex-row gap-5">
          {cards.map((c) => (
            ...
            >
              ...
              <svg
                className="absolute inset-0 w-full h-full pointer-events-none rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-700"
                style={{ zIndex: 0 }}
              >
                <rect
                  x="2"
              ...
              <div className="relative z-10 h-full flex flex-col pointer-events-none">
                ...
                <h3 className="font-serif text-xl leading-snug group-hover:text-electric transition-colors duration-300">
                  {c.title}
                </h3>
